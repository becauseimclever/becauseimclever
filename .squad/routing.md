...
|-----------|----------|----------|
| Architecture, design review, DDD enforcement | Tony | Layer violations, new abstractions, breaking changes |
| Backend APIs, domain model, infrastructure, DB | Banner | Entities, repositories, services, migrations |
| Blazor UI, components, themes, CSS | Wanda | New pages, component fixes, theme/style work |
| Tests, coverage, edge cases, E2E | Natasha | Unit/integration/E2E tests, coverage gaps |
| Code review | Tony | Review PRs, enforce quality gates |
